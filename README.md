# Robinhood on Rails
Robinhood on Rails is a simple front end dashboard for the free trading platform [Robinhood](https://robinhood.com/). You're presented with your autorefreshing portfolio after logging in:
