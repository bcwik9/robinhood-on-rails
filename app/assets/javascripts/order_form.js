OrderForm = function(element) {
  ...
  var get_order_description = function(type) {
    ...
    // SELL
      ...
      if(type == "Market"){
        return "The order will sell at the next best available price. Keep in mind that the price you see when you place the order may differ from the following price."
      } else if(type === "Limit") {
